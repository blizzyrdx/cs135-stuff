...
int main () {
    ...
    cout << setfill(' ') << setw(15) << left << weapon1 << right << setw(10) << qty_Scimitar << setw(15) << each1 << setw(15) << total_Scimitar << endl;
    cout << setfill(' ') << setw(15) << left << weapon2 << right << setw(10) << qty_Whip << setw(15) << each2 << setw(15) << total_Whip << endl;
